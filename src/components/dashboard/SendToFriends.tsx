...
import SendToFriendModal from '../modals/SendToFriendModal';
      ...
      <div className="p-4">
        ...
        <div className="px-6">
          <Link href="/dashboard/send-to-banks" className="flex items-center gap-2 bg-white p-4 rounded-lg w-full">
            <IoIosSend className="text-sky-600" size={40} />
            <p className="text-base w-[250px]">Send to abroad, local banks, and more</p>
          </Link>
        </div>
      </div>
